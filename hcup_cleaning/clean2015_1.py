"""
Script to clean and standardize the 2015 (Q1-Q3) HCUP dataset. Same logic
as 2008. 

Input: 
A csv file exported from IBM SPSS Statistics. 

Output: NY_SASD_2015q1q3_CORE_CLEANED.csv
"""
...
input_file = "NY_SASD_2015q1q3_CORE.csv"
output_file = "NY_SASD_2015q1q3_CORE_CLEANED.csv"
chunksize = 100_000 
print("Running...")

existing_cols = ["AGE", "AGEDAY", "AGEMONTH", "AHOUR", "AYEAR", "DHOUR", "DSHOSPID", "DURATION", "FEMALE",
                 "HCUP_OS", "DX_Visit_Reason1", "KEY", "ANESTH", "HISPANIC_X", "PAY2", "PAY2_X", "PAY3", "PAY3_X",
                 "LOS", "LOS_X", "NCPT", "PAY1", "PAY1_X", "ORTIME", "RACE", "TOTCHG", "NDX", "HCUP_SURGERY_BROAD_CPT", "HCUP_SURGERY_NARROW_CPT",
                 "HISPANIC", "OS_TIME",]
...
nonexisting_cols = ["I10_DX_VISIT_Reason", "NPR"]
