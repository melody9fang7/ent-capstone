...
Output: NY_SASD_2011_CORE_CLEANED.csv
"""
...
input_file = "NY_SASD_2011_CORE.csv"
output_file = "NY_SASD_2011_CORE_CLEANED.csv"
chunksize = 100_000  
print("Running...")

existing_cols = ["AGE", "AGEDAY", "AGEMONTH", "AHOUR", "AYEAR", "DHOUR", "DSHOSPID", "FEMALE",
                 "HCUP_OS", "DX_Visit_Reason1", "KEY", "ANESTH", "HISPANIC_X", "HCUP_SURGERY_BROAD", "HCUP_SURGERY_NARROW",
...
cols_to_numeric = [
    ...
    "HCUP_SURGERY_BROAD", "HCUP_SURGERY_NARROW",
...
rename_map = {
    ...
    "HCUP_SURGERY_BROAD":  "HCUP_SURGERY_BROAD_CPT",
    "HCUP_SURGERY_NARROW": "HCUP_SURGERY_NARROW_CPT",
}
