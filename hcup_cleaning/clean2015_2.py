"""
Script to clean and standardize the 2015 (Q4) HCUP dataset. Same logic
as 2008. From 2015 (Q4) onwards, I9 codes are replaced by I10 codes.

Input: 
A csv file exported from IBM SPSS Statistics. 

Output: NY_SASD_2015q4_CORE_CLEANED.csv
"""
...
input_file = "NY_SASD_2015q4_CORE.csv"
output_file = "NY_SASD_2015q4_CORE_CLEANED2.csv"
chunksize = 100_000  
print("Running...")

existing_cols = ["AGE", "AGEDAY", "AGEMONTH", "AHOUR", "AYEAR", "DHOUR", "DSHOSPID", "DURATION", "FEMALE",
                 "HCUP_OS", "I10_DX_Visit_Reason1", "KEY", "ANESTH", "HISPANIC_X", "PAY2", "PAY2_X", "PAY3", "PAY3_X",
                 "LOS", "LOS_X", "NCPT", "PAY1", "PAY1_X", "ORTIME", "RACE", "TOTCHG", "I10_NDX", "HCUP_SURGERY_BROAD_CPT", "HCUP_SURGERY_NARROW_CPT",
                 "HISPANIC", "OS_TIME"]
...
cols_to_string = [
    ...
    "I10_DX_Visit_Reason1", "I9_DX_VISIT_Reason"
]
